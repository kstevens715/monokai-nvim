...
vim.api.nvim_set_hl(0, 'Cursor', { fg = unnamed9, bg = light_text })
...
vim.api.nvim_set_hl(0, 'DiffChange', { fg = light_text, bg = light_grey })
vim.api.nvim_set_hl(0, 'DiffDelete', { fg = unnamed18 })
vim.api.nvim_set_hl(0, 'DiffText', { fg = light_text, bg = unnamed7, bold = true })
...
vim.api.nvim_set_hl(0, 'Folded', { fg = comment_grey, bg = unnamed9 })
...
vim.api.nvim_set_hl(0, 'Normal', { fg = light_text, bg = unnamed9 })
...
vim.api.nvim_set_hl(0, 'Search', { fg = light_text, bg = unnamed7 })
...
vim.api.nvim_set_hl(0, 'StatusLine', { fg = light_text, bg = status_back, bold = true })
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = light_text, bg = status_back })
