...
vim.api.nvim_set_hl(0, 'Pmenu', { bg = palette.grey5 })
...
vim.api.nvim_set_hl(0, '@constant', { fg = palette.sky_blue })
...
vim.api.nvim_set_hl(0, '@operator', { fg = palette.bright_pink })
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = palette.bright_pink })
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { fg = palette.bright_pink })
vim.api.nvim_set_hl(0, '@string', { fg = palette.string_yellow })
vim.api.nvim_set_hl(0, '@string.special.symbol', { fg = palette.purple })
vim.api.nvim_set_hl(0, '@symbol', { fg = palette.purple })
vim.api.nvim_set_hl(0, '@tag', { fg = palette.bright_pink })
...
vim.api.nvim_set_hl(0, '@variable.parameter', { fg = palette.orange, bold = true })

-- Treesitter ruby
vim.api.nvim_set_hl(0, '@ruby.callback', { fg = palette.bright_green })
vim.api.nvim_set_hl(0, '@ruby.debug', { fg = palette.bright_pink, bold = true })
vim.api.nvim_set_hl(0, '@ruby.entities', { link = '@ruby.callback' })
vim.api.nvim_set_hl(0, '@ruby.entity', { link = '@ruby.callback' })
vim.api.nvim_set_hl(0, '@ruby.macro', { link = '@ruby.callback' })
vim.api.nvim_set_hl(0, '@ruby.test_macro', { link = '@ruby.callback' })
vim.api.nvim_set_hl(0, '@ruby.validation', { link = '@ruby.callback' })
